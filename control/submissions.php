    ...
    <tbody>
        <?php
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo '</td><td><a title="View Letter" onclick="loadContent(\'preview\',\'id=' . $row['id'] . '\');">View Letter</a><a title="Delete" onclick="deleteLetter(' . $row['id'] . ');">Delete</a><a title="Send">Send</a></td></tr>';
            }
